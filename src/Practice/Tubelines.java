...
public class Tubelines
{
    public static void main(String[] args) {
        String[] zone1station = {"Aldgate", "Aldgate East", "Angel", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars", "Blackfriars",
                "Bond Street", "Borough", "Cannon Street", "Cannon Street", "Chancery Lane", "Charing Cross", "Charing Cross",
                "City Thameslink", "Covent Garden", "Earl's Court", "Edgware Road", "Elephant & Castle", "Elephant & Castle",
        ...
        alllines[3][0] = "Hammersmith and City Line";
        ...
        alllines[9][0] = "Waterloo And City Line";
